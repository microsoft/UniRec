...
RAW_DATA_PREFILE="$RAW_DATA_DIR/ml-100k/user_history.csv"
RAW_DATA_FILE="$RAW_DATA_DIR/ml-100k-libfm/ml-100k-libfm.txt"
...
dataset_name='ml-100k-libfm' ## gowalla amazon-book yelp2018
