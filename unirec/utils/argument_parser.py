...
def parse_cmd_arguments():
    ...
    parser.add_argument("--morec_ngroup", type=int, nargs="*", help="Number of groups for data sampling for each objective. \
                        The data would be split into N groups according to price/popularity. If ngroup for revenue is non-positive, group strategy is not used.")
