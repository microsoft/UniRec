...
DATASET_NAME="ES_final_next_item_dataset"  #"x-engmt-1m" #"Beauty"   
verbose=2
...
python unirec/main/main.py \
    ...
    --model_file='/home/v-leiyuxuan/working_dir/UniRec/output/ES_final_dataset/SASRec/train/checkpoint_2023-06-24_032006_58/SASRec-SASRec.pth' \
    --load_best_model=1 \
    --seq_last=1